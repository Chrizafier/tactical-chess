      ...
      <View style={styles.container}>
        ...
        <DataTable>
          <DataTable.Header>
            ...
            <DataTable.Title numeric><Text style={styles.tableHeaderText}>Attack Points</Text></DataTable.Title>
            <DataTable.Title numeric><Text style={styles.tableHeaderText}>Health Points</Text></DataTable.Title>
          </DataTable.Header>
